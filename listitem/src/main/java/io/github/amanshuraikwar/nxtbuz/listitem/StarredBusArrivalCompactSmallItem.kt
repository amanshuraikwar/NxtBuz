    ...
    init {
        when (busArrival.busArrivals) {
            is BusArrivals.Arriving -> {
                (busArrival.busArrivals as BusArrivals.Arriving).nextArrivingBus.let {
...
//                        }
//                }
//                if ((busArrival.busArrivals as BusArrivals.Arriving).followingArrivingBusList.isNotEmpty()) {
//                    (busArrival.busArrivals as BusArrivals.Arriving).followingArrivingBusList[0].let {
...
//                    }
//                }
//                if ((busArrival.busArrivals as BusArrivals.Arriving).followingArrivingBusList.size >= 2) {
//                    (busArrival.busArrivals as BusArrivals.Arriving).followingArrivingBusList[1].let {
